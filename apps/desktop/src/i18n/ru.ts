...
export const ru = defineLocale({
  ...
  settings: {
    ...
    config: {
      fileOpenAppTitle: "Чем открывать файлы",
      fileOpenAppDesc: "Где открываются файлы, отправленные из Hermes. Системный вариант следует ассоциации файлов в ОС, а её молча переписывают установщики и обновления инструментов — выберите приложение здесь, чтобы закрепить. Показаны только приложения, найденные на этом компьютере.",
      fileOpenAppSystem: "Системное приложение",
      fileOpenAppLabel: "Приложение для открытия файлов",
      fileOpenAppEmpty: "На этом компьютере поддерживаемые редакторы не найдены.",
